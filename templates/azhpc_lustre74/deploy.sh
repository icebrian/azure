...
echo -e "Disks per storage node: ${YELLOW}$storageDisks${NC}"
echo -e "Disks size in storage nodes: ${YELLOW}$SSDSIZE${NC}"
...
sed -i "s%_SSDSIZE%$SSDSIZE%g" parameters/parameters-server.json
